...
# This will allow us to type the title of the gaame
# when the user first opens the game
...
class Player:
    ...
    def __init__(self):
        ...
        self.y = HEIGHT - PLAYER_HEIGHT - 10 # Near the bottom
        self.width = PLAYER_WIDTH 
        self.height = PLAYER_HEIGHT
        self.speed = 5 # How fast the player moves
    ...
    def move(self, keys):
        ...
        if keys[pygame.K_UP] and self.y > 0:
            self.y -= self.speed
        if keys[pygame.K_DOWN] and self.x < HEIGHT - self.height:
            self.y += self.speed
